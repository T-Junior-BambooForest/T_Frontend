        ...
        <div>
            ...
            <div className='title_box_wrap'>
                ...
                <div className='follow_btn_box_link'>
                    <a className='a_link_button' href='https://google.com' target={'_blank'} rel={'noreferrer'}>Follow</a>
                </div>
            </div>
        </div >
    );
