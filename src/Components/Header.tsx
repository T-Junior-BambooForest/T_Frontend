        ...
        <div>
            <div className='header_wrap' >
                ...
                <div className='login_btn'>
                    {user.isLogin ? '' :
                        <><span><a className='login_sub_btn' href={validateURL('https://auth.bssm.kro.kr/oauth?clientId=4bff670f&redirectURI=https://bsmboo.kro.kr:8000/oauth') ? 'https://auth.bssm.kro.kr/oauth?clientId=4bff670f&redirectURI=https://bsmboo.kro.kr:8000/oauth' : ''}>LOGIN</a></span>&nbsp;&nbsp;|&nbsp;&nbsp;</>}
